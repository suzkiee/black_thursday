...
RSpec.describe SalesAnalyst do
  ...
  describe 'methods' do
    ...
    it '#average_item_price_standard_deviation' do
      ...
      expect(sales_analyst.average_item_price_standard_deviation).to eq(3.26)
    end
    ...
    it '#average item price for merchant' do
      ...
      expect(sales_analyst.average_item_price_for_merchant(12334105)).to eq(0.25106e3)
    end

    it '#average average price per merchant' do
      sales_analyst = @sales_engine.analyst

      expect(sales_analyst.average_average_price_per_merchant).to eq(0.25106e3)
    end
